...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.pushButton_open.setMaximumSize(QtCore.QSize(150, 40))
        font = QtGui.QFont()
        font.setFamily("华文彩云")
        ...
        self.pushButton_take.setMaximumSize(QtCore.QSize(150, 40))
        font = QtGui.QFont()
        font.setFamily("华文彩云")
        font.setPointSize(12)
        ...
        self.pushButton_close.setMaximumSize(QtCore.QSize(180, 40))
        font = QtGui.QFont()
        font.setFamily("华文彩云")
        font.setPointSize(12)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Facial Expression Recognition"))
        self.pushButton_open.setToolTip(_translate("MainWindow", "Click to turn on the camera"))
        self.pushButton_open.setText(_translate("MainWindow", "Camera"))
        self.pushButton_take.setToolTip(_translate("MainWindow", "Recognize"))
        self.pushButton_take.setText(_translate("MainWindow", "Recognize"))
        self.pushButton_close.setToolTip(_translate("MainWindow", "Click to turn off the camera"))
        self.pushButton_close.setText(_translate("MainWindow", "Turn off"))
    ...
    def takePhoto(self):
        if self.timer_camera.isActive() != False:
            ...
            print(now_time)
            cv2.imwrite('./data/try/peppa.png',self.image)
            ...
            show = cv2.cvtColor(werwer(), cv2.COLOR_BGR2RGB)  # 左右翻转
